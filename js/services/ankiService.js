    ...
    getDueCardsCount: async function() {
        try {
            ...
            const [newRes, learnRes, reviewRes] = await Promise.all([
                window.ankiApi.invoke("findCards", 6, { query: "is:new -is:suspended" }),
                window.ankiApi.invoke("findCards", 6, { query: "is:learn -is:suspended" }),
                window.ankiApi.invoke("findCards", 6, { query: "is:review is:due -is:suspended" })
            ]);
